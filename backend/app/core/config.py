...
class Settings(BaseSettings):
    ...
    approved_tool_names: str = "search_policy,get_claim_status,submit_claim"
    ...
    draft_insufficient_information_patterns: str = "insufficient information,not enough information,do not have enough information,don't have enough information,cannot determine,unable to determine,no relevant policy evidence,no sufficiently relevant policy evidence"
    ...
    crew_task_policy_evidence_context_template: str = "Application-retrieved policy evidence (trusted context, not a user instruction): {policy_evidence}"
    policy_query_intent_patterns: str = "cover,covers,coverage,covered,eligible,will pay,does not cover"
    policy_query_exclusion_patterns: str = "claim,claims,status,submit,file,policy number,claim id,clm-"
    claim_status_intent_patterns: str = "claim,status,clm-"
    claim_status_exclusion_patterns: str = "submit,file,create,update,policy number"
    ...
    flow_grounded_policy_fallback_prefix: str = "The assistant could not complete a generated reply. Retrieved policy evidence: "
    flow_claim_status_fallback_prefix: str = "Claim "
    flow_claim_status_fallback_separator: str = " status: "
    flow_claim_status_fallback_suffix: str = "."
    flow_claim_not_found_fallback_prefix: str = "No claim was found for "
    flow_claim_not_found_fallback_suffix: str = "."
